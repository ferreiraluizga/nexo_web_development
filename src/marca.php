                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-primary rounded-3 me-4 fw-light opacity-75" href="<?php if (isset($_GET['search'])) { ?> pdf.php?pdf=marca&&search=<?php echo $_GET['search'];
                                    } else { ?>pdf.php?pdf=marca<?php } ?>">Exportar
                                        PDF</a>
                                </div>
                            </div>
                            <br>
