                    ...
                    <form class="d-flex" role="search" method="GET" action="dashboard.php">
                        <div class="input-group col-12 col-md-8 col-lg-6" style="min-width: 250px; max-width: 800px">
                            <input type="search" name="search" class="form-control" placeholder="<?php if (isset($_GET['search'])) {
                                echo $_GET['search'];
                            } else { ?>Digite o nome do produto <?php } ?>" aria-label="search"
                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-primary rounded-3 me-4 fw-light opacity-75" href="<?php if (isset($_GET['search'])) { ?> pdf.php?pdf=produtos&&search=<?php echo $_GET['search'];
                                    } else { ?>pdf.php?pdf=produtos<?php } ?>">Exportar
                                        PDF</a>
                                </div>
                            </div>
                            <br>
