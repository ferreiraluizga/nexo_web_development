            ...
            <div class="responsive-div p-4 w-100">
                ...
                <div class="container-fluid h-100 p-3">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <?php
                            $marcaController = new MarcaController(); // Instância do pessoaController
                            $marcas = $marcaController->buscarPorCod_Marca($_GET['Cod_Marca']);
                            ?>
                            <form method="POST"
                                action="controller/marcaController.php?acao=atualizar&Cod_Marca=<?php echo $marcas['Cod_Marca'] ?>">
                                ...
                                <div class="input-group mb-3" name="nome_marca">
                                    <input type="text" class="form-control" name="nome_marca" required
                                        value="<?php echo $marcas['Nome_Marca']; ?>">
                                </div>
                                <br>
                                <div class="mb-3">
