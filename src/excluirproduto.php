                ...
                <div class="container-fluid h-100 p-3">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            ...
                            ?>
                            <form method="POST"
                                action="controller/produtoController.php?acao=excluir&Cod_Prod=<?php echo $produtos['Cod_Prod'] ?>">

                                <p class="fs-5">Nome:</p>
                                <div class="input-group mb-3" name="nome_prod">
                                    <input type="text" class="form-control" name="nome_prod"
                                        value="<?php echo $produtos['Nome_Prod']; ?>" disabled>
                                </div>
                                <br>
                                <p class="fs-5">Preço:</p>
                                <div class="input-group mb-3" name="preco">
                                    <input type="text" class="form-control" name="preco"
                                        value="<?php echo $produtos['Preco_Prod']; ?>" disabled>
                                </div>
                                <br>
                                ...
                                <div class="input-group mb-3" name="quantidade_prod">
                                    <input type="text" class="form-control" name="quantidade_prod"
                                        value="<?php echo $produtos['Quant_Estoque']; ?>" disabled>
                                </div>
                                <br>
                                <p class="fs-5">Código do fornecedor:</p>
                                <select class="form-select" aria-label="Default select example" name="cod_forn" disabled>
                                ...
                                <select class="form-select" aria-label="Default select example" name="cod_marca" disabled>
                                ...
                                <br><br>
                                <div class="mb-3">
                                    <button class="btn btn-primary rounded-3 me-4 fw-light" type="submit">Excluir</button>
                                </div>
                            </form>
