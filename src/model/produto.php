...
class Produto{ //Classe publica
    ...
    public function buscarPorCod_Prod($Cod_Prod){  //Método buscarPorId
    ...
    public function buscarPorCod_Forn($Cod_Forn){  //Método buscarPorId
    ...
    public function buscarPorCod_Marca($Cod_Marca){  //Método buscarPorId
    ...
    public function buscarPorCod_Categoria($Cod_Categoria){  //Método buscarPorId
