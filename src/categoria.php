                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col d-flex justify-content-end">
                                    ...
                                    <a class="btn btn-primary rounded-3 me-4 fw-light opacity-75" href="<?php if (isset($_GET['search'])) { ?> pdf.php?pdf=categoria&&search=<?php echo $_GET['search'];
                                    } else { ?>pdf.php?pdf=categoria<?php } ?>">Exportar
                                        PDF</a>
                                </div>
                            </div>
                            <br>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_GET['search'])) {
                                                ...
                                                foreach ($listas as $lista) {
                                                    ...
                                                    <tr>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($lista['Cod_Categoria']); ?>
                                                        </th>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($lista['Nome_Categoria']); ?>
                                                        </th>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($lista['Desc_Categoria']); ?>
                                                        </th>
                                                        <th>
                                                ...
                                                foreach ($categorias as $categoria) {
                                                    ...
                                                    <tr>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($categoria['Cod_Categoria']); ?>
                                                        </th>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($categoria['Nome_Categoria']); ?>
                                                        </th>
                                                        <th class="fw-normal">
                                                            <?php echo htmlspecialchars($categoria['Desc_Categoria']); ?>
                                                        </th>
                                                        <th>
                                                            <a class="btn btn-primary rounded-5 me-4 mb-2"
