            ...
            <div class="responsive-div p-4 w-100">
                ...
                <div class="container-fluid h-100 p-3">
                    <div class="card border-0">
                        ...
                        <div class="card-body">
                            <form method="POST" action="controller/categoriaController.php?acao=inserir">
                                ...
                                <br>
                                <div class="mb-3">
                                    <button class="btn btn-primary rounded-3 me-4 fw-light" type="submit">Cadastrar</button>
                                </div>
                            </form>
