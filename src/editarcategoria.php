                ...
                <div class="container-fluid h-100 p-3">
                    <div class="card border-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="text-align: end;">
                                    <a button class="btn btn-primary rounded-3 me-4 fw-light opacity-75" type="button"
                                        href="categoria.php">Voltar</button></a>
                                </div>
                            </div>
                            <br>
                        </div>
                        <div class="card-body">
                            ...
                            <?php
                            $categoriaController = new CategoriaController(); // Instância do pessoaController
                            $categorias = $categoriaController->buscarPorCod_Categoria($_GET['Cod_Categoria']);
                            ?>
                            <form method="POST"
                                action="controller/categoriaController.php?acao=atualizar&Cod_Categoria=<?php echo $categorias['Cod_Categoria'] ?>">
                                <!-- Endereço de onde os dados são enviados  -->
                                <p class="fs-5">Nome da Categoria:</p>
                                <div class="input-group mb-3" name="nome_categoria">
                                    <input type="text" class="form-control" name="nome_categoria" required
                                        value="<?php echo $categorias['Nome_Categoria']; ?>">
                                </div>
                                <p class="fs-5">Descrição:</p>
                                <div class="input-group mb-3" name="desc_categoria" required>
                                    <input type="text" class="form-control" name="desc_categoria" required
                                        value="<?php echo $categorias['Desc_Categoria']; ?>">
                                </div>
                                <br>
                                <div class="mb-3">
